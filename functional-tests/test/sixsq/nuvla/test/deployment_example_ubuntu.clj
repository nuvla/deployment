(ns sixsq.nuvla.test.deployment-example-ubuntu
  (:require
...
(defn tests
  ...
  (let [examples-root (env :examples-root)]
    ...
    (module/add-module (str/join "/" [examples-root "example-ubuntu"]))

    (when-let [module-id (module/get-module-by-path "examples/ubuntu")]
