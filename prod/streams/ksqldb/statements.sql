...
WITH (KAFKA_TOPIC='notification-method', PARTITIONS=3, REPLICAS=3, VALUE_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='subscription', PARTITIONS=3, REPLICAS=3, VALUE_FORMAT='JSON');
...
WITH (KAFKA_TOPIC='event', PARTITIONS=3, REPLICAS=3, VALUE_FORMAT='JSON');
